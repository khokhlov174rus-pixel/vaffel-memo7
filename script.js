    ...
    setupPromoCodeCopy() {
        ...
        setTimeout(() => {
            ...
            function fallbackCopyTextToClipboard(text) {
                ...
                // Устанавливаем кодировку UTF-8 для правильной обработки русских символов
                textArea.value = text;
            ...
            if (promoCode) {
                promoCode.addEventListener('click', () => {
                    // Берем промокод напрямую из конфига, чтобы избежать проблем с кодировкой
                    const textToCopy = this.config.game.promoCode;
